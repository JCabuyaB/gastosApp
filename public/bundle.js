...
const abrirFormulario = (modo = 'agregarGasto') => {
    ...
    if(modo === 'editarGasto'){
        formulario$1.dataset.modo = 'editar-gasto';
        formulario$1.querySelector('.formulario-gasto__titulo').innerText = 'Editar gasto';
        formulario$1.querySelector('.formulario-gasto__btn').innerText = 'Editar gasto';
        return;
    }
    
    // adecuar formulario para agregar
    formulario$1.dataset.modo = 'agregar-gasto';
    formulario$1.querySelector('.formulario-gasto__titulo').innerText = 'Agregar gasto';
    formulario$1.querySelector('.formulario-gasto__btn').innerText = 'Agregar gasto';
};
...
const cerrarFormulario = () => {
    ...
    const id = formulario$1.dataset?.id;
    // remover id si tiene
    if(id){
        formulario$1.removeAttribute('data-id');
        ...
        gastosDelMes.forEach((gasto) => {
            ...
            <div class="gasto" data-id="${gasto.id}">
                <div class="gasto__info">
                    ...
                    <p class="gasto__fecha">${format(parseISO(gasto.fecha), "d 'de' MMMM 'de' yyyy")}</p>
                </div>
